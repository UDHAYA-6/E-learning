...
def success(request):
    ...
    server.login("shopskill.learn@gmail.com", "hbyf jjef gvjb imgg")
    ...
    if request.method == "POST":
        ...
        if valid1 and valid2:
            ...
            if p_k1.pk == p_k2.pk:
                ...
                v11 = request.session['End']
                End2 = v11 + timedelta(week*7)
                days = End2-Start
                day = days.days
    ...
    if request.method=="POST":
        ...
        if validation1:
            ...
            if validation2:
                ...
                if p_k1.pk == p_k2.pk:
                    data = Instructor.objects.filter(Email=t1)
                    return render(request,"Welcome instructor.html", {"data":data})
                else:
                    message = "Email/password incorrect"
